...
${iOS_EN_HelpUsProvideInfoQuickLink}        chain=**/XCUIElementTypeOther[`name BEGINSWITH "Help us provide you with timely services and information. Keep your email address up-to-date."`][-1]
${iOS_EN_HealthBeginsWithYouQuickLink}        chain=**/XCUIElementTypeStaticText[`name BEGINSWITH "The journey to health begins with you"`]
${iOS_EN_HealthBeginsWithYouQuickLink_LetsStart}        accessibility_id=Let’s start now
