...
#    Mainframe3270.Take Screenshot
#    ScreenCapLibrary.Take Screenshot    name=screenshot    format=jpg    quality=0
...
#    \\${msg}.png
    ...
    la Screenshot    Y:L:10.16.95.21:992 - wc3270    ${ScreenPathName}    ${count}_LA_${msg}
...
#    create file    ./${path}/actual_value.txt

Capture Message
    [Arguments]    ${row}    ${col}    ${len}
#    ${irow}    Convert To Integer    ${row}
#    ${icol}    Convert To Integer    ${col}
#    ${ilen}    Convert To Integer    ${len}
...
#    #Pause Execution
    ...
    Send PF    5
#    IF    '${rider_code}' == 'RH3A'
##    Execute Command    MoveCursor(13, 31)
##    Execute Command    PA(1)
##    Send PF    4
##    Pause Execution
#    END
